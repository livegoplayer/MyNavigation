...
public class Road {
    ...
    public double CongestionDegree ;            //拥堵程度
    public double speed;            //行车速度（指的是到该路上行驶的速度，并非当前统计的速度）
    public Level RoadLevel;         //道路的等级

    public Road(ArrayList<Position> polylines, String ID, String roadName, double roadLength, Position startPoint, Position enPoint, double speed, Level roadLevel) {
